...
class SMPL(nn.Module):
    def __init__(self, gender='neutral'):
        ...
        model_file=os.path.dirname(__file__)+'/data/basicmodel_%s_lbs_10_207_0_v1.1.0.pkl'%gender
        self.gender = gender
        with open(model_file, 'rb') as f:
            smpl_model = pickle.load(f, encoding='iso-8859-1')
        self.vert_num = smpl_model['v_template'].shape[0]
        ...
        J_regressor_shape = [24, self.vert_num]
